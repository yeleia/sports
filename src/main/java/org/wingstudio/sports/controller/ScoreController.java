...
public class ScoreController {
    ...
    public Map<String,Object> getSoloScoreNoCheck(@ModelAttribute Page page,@RequestParam(value = "taketime")String taketime){
    ...
    public Map<String,Object> getTeamScoreNoCheck(@ModelAttribute Page page,@RequestParam(value = "taketime")String taketime){
    ...
    public Map<String,Object> getTeamScoreCheck(@ModelAttribute Page page ,@RequestParam(value = "taketime")String taketime){
